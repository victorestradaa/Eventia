          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-16">
              ...
              <p className="text-[var(--color-texto-suave)]">
                Eventium es un mercado digital (marketplace) y una herramienta de gestión. Nuestra plataforma proporciona el espacio y la tecnología para que Clientes y Proveedores se conecten, coticen, planifiquen y reserven servicios para eventos.
              </p>
            </section>
            ...
            <section className="mb-16">
              ...
              <ul className="space-y-6 text-[var(--color-texto-suave)] list-none p-0">
                ...
                <li className="flex gap-3 items-start text-red-500 bg-red-500/5 p-6 rounded-3xl border border-red-500/10 font-medium">
                  ...
                  <span>Eventium se reserva el derecho de suspender o cancelar cuentas que violen estas normas, publiquen contenido inapropiado o realicen prácticas fraudulentas.</span>
                </li>
              </ul>
            </section>
            ...
            <section className="mb-16">
              ...
              <p className="bg-red-500/5 p-6 rounded-3xl border border-red-500/20 text-red-600 dark:text-red-400 font-bold mb-8">
                Eventium actúa exclusivamente como un intermediario tecnológico. No somos una agencia de organización de eventos, ni los dueños, operadores o prestadores de los servicios anunciados.
              </p>
              <p className="text-[var(--color-texto-suave)] mb-6">Eventium no garantiza ni asume responsabilidad por:</p>
            ...
            <section className="mb-16">
              ...
              <div className="space-y-4 text-[var(--color-texto-suave)]">
                <p>Los pagos realizados a través de la plataforma son procesados por <strong className="text-[var(--color-texto)]">Mercado Pago</strong>. Eventium no almacena información bancaria de los usuarios.</p>
                <p>Eventium puede cobrar una comisión por el uso de la tecnología de intermediación. Esta comisión se detallará claramente antes de confirmar cualquier transacción y no es reembolsable por parte de Eventium.</p>
            ...
            <div className="space-y-12">
              <section>
                ...
                <p className="text-[var(--color-texto-suave)] text-sm">Cada Proveedor es responsable de establecer sus propias políticas de cancelación. Al reservar, el Cliente acepta dichas políticas. Eventium no tiene autoridad para obligar a reembolsos fuera de las políticas establecidas.</p>
              </section>

              <section>
                <h3 className="text-xl font-bold mb-4 text-[var(--color-texto)] uppercase tracking-tight">6. Propiedad Intelectual</h3>
                <p className="text-[var(--color-texto-suave)] text-sm">Todo el contenido, diseño visual y código fuente son propiedad exclusiva de Eventium. Queda prohibida su reproducción sin autorización.</p>
              </section>
